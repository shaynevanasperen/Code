...
namespace Code.Extensions.Exception
{
	...
	static partial class ExceptionExtension
	{
		...
		private static string CanonicalizeException(System.Exception exception)
		{
			try
			{
...
#pragma warning restore CA5350 // Do Not Use Weak Cryptographic Algorithms
		...
		private static string StackTraceWithoutVariantFilePaths(System.Exception exception)
		{
			var firstFrame = true;
		...
		private static void AddMethodName(MethodBase method, StringBuilder builder)
		{
		...
		private static void AddGenericParameters(MethodBase method, StringBuilder builder)
		{
		...
		private static void AddLineNumber(StackFrame stackFrame, StringBuilder builder)
		{
			...
			if (lineNumber != 0)
			{
				builder.Append($" line: {stackFrame.GetFileLineNumber()}");
			}
		}
	}
}
